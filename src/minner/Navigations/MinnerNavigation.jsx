...
import { signOutMinnersync } from "../ComponentAuth/minnerAuthSlice";
import { selectMinnerData } from "../ComponentOprate/minnerSlice";

const navigation = [
  { name: "Home", to: "/MinnerProfile", minner: true },
  { name: "Mine Votes", to: "/MinerCountVote", minner: true },
];
